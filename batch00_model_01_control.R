...
setwd("D:\\博士论文写作202107\\1大论文中\\1大论文中\\RESULTS\\6_Seat_modeling\\data_F")


#Step 1: Write Model in Stan 鈥?-
...
RLdata_dict <-list(
  ...
  drift_scaling_priors=c(100,30,30,30),
  threshold_priors= c(200,100,30,30),
...
for (reprep in 1:100){
  ...
  #View(m)
  whichtime = Sys.Date()
  filename = sprintf("%s_seat_control_model_01_%s.rds",reprep,whichtime)
